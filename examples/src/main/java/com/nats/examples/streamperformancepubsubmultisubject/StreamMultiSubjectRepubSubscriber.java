...
public class StreamMultiSubjectRepubSubscriber {
	public static String[] SERVER = new String[] { "nats://localhost:4223" };

	private static String STREAM = "stream-1";
	private static String SUBJECTPREFIX = "repub";
	private static int STARTINDEX = 0;
	private static int STOPINDEX = 9999;
	private static long STARTDELAY = 5;
